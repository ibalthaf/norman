...
<html lang="en">
	<head>
		...
		?>
		<link href="css/report-templates/scaffolding/site-supervisor.css" type="text/css" rel="stylesheet">
		<?php
			else:
				$logo = "images/Norman-Group-logo-5.png";
		?>
		<link href="css/report-templates/brickwork/site-supervisor.css" type="text/css" rel="stylesheet">
		<?php
			endif;
		?>
	</head>
