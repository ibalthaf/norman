...
<html lang="en">
	<head>
		...
		?>
		<link href="css/report-templates/scaffolding/toolbox-talk-register.css" type="text/css" rel="stylesheet">
		<?php
			else:
				$logo = "images/Norman-Group-logo-5.png";
		?>
		<link href="css/report-templates/brickwork/toolbox-talk-register.css" type="text/css" rel="stylesheet">
		<?php
			endif;
		?>
	</head>
