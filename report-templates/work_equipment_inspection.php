...
<html lang="en">
	<head>
		...
		?>
		<link href="css/report-templates/scaffolding/work_equipment_inspection.css" type="text/css" rel="stylesheet">
		<?php
			else:
				$logo = "images/Norman-Group-logo-5.png";
		?>
		<link href="css/report-templates/brickwork/work_equipment_inspection.css" type="text/css" rel="stylesheet">
		<?php
			endif;
		?>
	</head>
