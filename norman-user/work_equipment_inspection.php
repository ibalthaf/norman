				...
				<div class="right_col" role="main">
					<div class="">
						<div class="row x_title">
							<div class="col-md-6">
								<h3>Welcome <font class="lbl-adminid"></font> <small> > Manage Forms </small> <small> > WORK EQUIPMENT INSPECTION FORM </small></h3>
							</div>
							<div class="col-md-6">
								...
								<div class="x_panel">
									...
									<div class="x_content">
										<div class="table-responsive text-center">
											<table class="table table-striped jambo_table bulk_action" id="work-equipment-table">
												<thead>
													<tr class="headings">
														...
														<th class="column-title text-center">Inspection Completed By</th>
				...
				<script>
				$.getScript('scripts/viewmodel/work-equipment-inspection.js',function(){
