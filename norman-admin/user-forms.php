<?php include("header.php"); ?>
										...
										<div class="col-md-8 col-lg-8 col-sm-7">
											...
											<div class="register-user-submit-button text-right">
												<div class="add-new-submit-button">
													<div class="container">
														<button type="button" name="btnNewUser" id="btnNewUser" class="btn btn-primary" data-bind="click:addmformassign">Submit</button>
				...
				<script>
				$.getScript('scripts/viewmodel/user-forms.js',function(){
					ko.applyBindings(userforms);
					userforms.init();
				});
				</script>
