				...
				<div class="col-md-3 col-sm-12 col-xs-12 left_col">
					<div class="left_col scroll-view">
						...
						<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
							<div class="menu_section">
								<ul class="nav side-menu login-side-menu">
									<!-- Dynamic menue append based on user login -->
								</ul>
							</div>
						</div>
						<!-- /sidebar menu -->
						...
						<!--<div class="sidebar-footer hidden-small">
							<a href="dashboard.php" data-toggle="tooltip" data-placement="top" title="Dashboard">
								<span class="glyphicon glyphicon-home" aria-hidden="true"></span>
							</a>
							<a href="sites-management.php" data-toggle="tooltip" data-placement="top" title="Site Management">
								<span class="glyphicon glyphicon-equalizer" aria-hidden="true"></span>
							</a>
							<a href="form-management.php" data-toggle="tooltip" data-placement="top" title="Generate Report">
								<span class="glyphicon glyphicon-file" aria-hidden="true"></span>
							</a>
							<a title="Logout" class="logout" data-toggle="tooltip" data-placement="top">
							...
							<ul class="nav navbar-nav navbar-right">
								...
								<li class="">
									<a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
										<img src="images/loader-sm.gif" alt="Profile Image" class="profile_img"><label class="lbllogin"></label>
									</a>
								</li>
							</ul>
						</nav>
