...
//get registered user list
	...
	//server action
        service.operationDataService('get_toolboxtalk_report', JSON.stringify(data), function(data){
		//prepare datatable
			$('#toolbox-talk-table').dataTable( {
				data: data.data,
				columns: [
					{
						'data'	: null,
					...
					{'data': 'input_1'},
					{
						...
						'class' : 'text-center',
						'render': function ( data, type, full, meta ) {
							return "<img src='data:image/png;base64,"+data+"' width='50px' />";
						}
					},
					{'data': 'topic'},
					{'data': 'citp_gt'},
