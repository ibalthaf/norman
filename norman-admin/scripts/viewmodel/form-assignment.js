				...
				columns: [
					...
					},
					{
						...
						'render': function ( data, type, full, meta ) {
							var html = "";
						//Menu assignment
							html += '<a href="user-forms.php?id='+data+'&type='+full.worktype+'" class="btn btn-success btn-xs menu-assignment" data-userid="'+data+'" title="Menu Assignment"><i class="fa fa-plus-circle"></i> Assign</a>';
						//return
							return html;
						}
					}
