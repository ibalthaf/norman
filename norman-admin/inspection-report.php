				...
				<div class="right_col" role="main">
					<div class="">
						<div class="row x_title">
							<div class="col-md-6">
								<h3>Welcome <font class="lbl-adminid"></font> <small> > Forms Management </small> <small> > SCAFFOLD INSPECTION FORM </small></h3>
							</div>
							<div class="col-md-6">
								...
								<div class="x_panel">
									...
									<div class="x_content">
										<div class="table-responsive">
											<table class="table table-striped jambo_table bulk_action" id="method-statement-table">
												<thead>
													<tr class="headings">
														...
														<th class="column-title text-center">Inspected By</th>
				...
				<script>
				$.getScript('scripts/viewmodel/inspection-report.js',function(){
