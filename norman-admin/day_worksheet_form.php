				...
				<div class="right_col" role="main">
					<div class="">
						<div class="row x_title">
							<div class="col-md-6">
								<h3>Welcome <font class="lbl-adminid"></font> <small> > Manage Forms </small> <small> > DAYWORK SHEET FORM </small></h3>
							</div>
							<div class="col-md-6">
				...
				<script>
				$.getScript('scripts/viewmodel/day_worksheet_form.js',function(){
